...
The Debt Sustainability Monitor 2025 outlines the Commission's medium-term projection methodology. It integrates Commission forecasts with assumptions about potential growth, output gap convergence, structural primary balances, inflation, interest payments, ageing-related expenditures, stock-flow adjustments, deterministic stress scenarios, and stochastic risk analyses (European Commission, 2026). The empirical approach adopted in this paper does not estimate an output gap equation directly; rather, it explicitly estimates real GDP responses, treating the Commission's assumption on output gap convergence solely as a component of the evaluated baseline projection environment. Macroeconomic feedback from fiscal interventions enters via GDP, cyclical budget elements, subsequent primary balance trajectories, and debt dynamics driven by the interest-growth differential. Within the reformed framework, these projections support prior fiscal guidance, assessments of medium-term structural fiscal plans, Council-approved net expenditure ceilings, annual progress evaluations, and corrective pathways under the excessive deficit procedure.
...
The baseline adopted is the Commission's Debt Sustainability Monitor projection, produced within the EU fiscal surveillance framework. This paper treats that baseline as an externally provided reference path without re-estimation. The baseline integrates the Commission's forecast round and incorporates assumptions on potential growth, output gap closure, inflation, interest expenditure, ageing-related costs, stock-flow adjustments, structural balances, primary balances, and the debt dynamics equation. Under these assumptions, Poland's general government gross debt ratio increases from 55.1 percent of GDP in 2024 to 106.8 percent in 2036, surpassing the 60 percent Treaty reference value. At the same endpoint, the structural balance reaches approximately -10 percent of GDP, with the primary balance around -3.9 percent of GDP.

The implausibility is arithmetic before it is behavioural and can be read directly from the Commission's own inputs. The baseline's implied nominal interest rate on government debt rises from about 4.8 percent in 2025 to about 6.2 percent in 2036, and the implied real rate rises from roughly 1.2 percent to roughly 3.4 percent over the same span. The interest-growth differential, favourable at first, changes sign during the projection period. Nominal growth exceeds the implied interest rate until 2029 but falls short from 2030 onward, so the snowball term that initially lowers the debt ratio begins to raise it. By 2036, the differential alone adds about 0.9 percentage point to the debt ratio each year before any primary deficit is counted.

The decomposition of the change in the debt ratio into a snowball term, the primary balance, and the stock-flow adjustment, together with the condition that the ratio stabilises only when the primary balance roughly matches the differential multiplied by the lagged debt ratio, makes the gap explicit (Checherita-Westphal and Domingues Semeano, 2020). Evaluating that condition at the 2036 debt ratio of 106.8 percent of GDP and the baseline's own 2036 differential shows that stabilising the ratio would require a primary surplus of about one percent of GDP. The baseline instead assumes a primary deficit near -3.9 percent.

The distance between the assumed primary balance and the debt-stabilising balance is therefore close to five percentage points of GDP, and it must be closed merely to stop the ratio from rising, before any reduction. The baseline closes none of it: the primary deficit remains inside a narrow band of roughly -3.6 to -4.3 percent of GDP across the whole horizon, and a structural balance near -10 percent of GDP at the endpoint is not a fiscal stance any government could hold as stable.

A reading through risk-pricing and institutional channels points the same way. A debt ratio exceeding the 60 percent Treaty reference value while the excessive deficit procedure remains active would expose the path to debt-service and interest-growth channels in debt dynamics (Blanchard, 2019; European Commission, 2026), as well as to market-pricing channels through sovereign-risk concerns, yields, and economy-wide borrowing costs (Huidrom, Kose, Lim and Ohnsorge, 2019). EU institutions would also assess the path through surveillance and corrective-procedure rules (European Commission, 2026). Domestic policymakers, in turn, would operate within Poland's constitutional and statutory fiscal constraints, the medium term fiscal structural plan, and the annual progress reporting framework (Constitution of the Republic of Poland, 1997; Public Finance Act, 2009; Ministry of Finance of Poland, 2024, 2025).

The path is therefore a Commission surveillance construct: a no-additional-measures projection that holds corrective measures outside the baseline so that fiscal risks can be measured against a common reference path (European Commission, 2026). The arithmetic is the load-bearing point: the baseline endpoint is a surveillance counterfactual under strained debt dynamics, not a fiscal path that the Polish government could select and sustain under the cited surveillance and domestic legal constraints.
