...
Against this institutional background, the scenario exercise takes the Commission's Debt Sustainability Monitor as its reference path. That path is used as a surveillance baseline to be evaluated, not accepted as a plausible policy path; the next paragraphs explain why its assumptions are too demanding. On that baseline, Poland's general government gross debt ratio rises from 55.1 percent of GDP in 2024 to 106.8 percent of GDP in 2036, above the 60 percent Treaty reference value (European Commission, 2026).
...
The baseline shows what the Commission's framework implies before later corrective measures are added (European Commission, 2026). The scenario results below therefore report margins relative to that Commission construction.
