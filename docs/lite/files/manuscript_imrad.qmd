...
The excessive deficit procedure carries institutional authority because non-compliance can trigger Council recommendations, an assessment of effective action, a revised fiscal adjustment trajectory, closer monitoring, and further escalation under the corrective arm (European Commission, 2026; Council of the European Union, 2025). Euro area member states are also subject to legal provisions for deposits or financial penalties (European Commission, 2026). Poland is outside the euro area, so direct financial sanctions do not apply immediately under the euro area sanctions channel (European Commission, 2026; Ministry of Finance of Poland, 2025).

For Poland, compliance pressure therefore runs through Council-approved adjustment requirements, annual surveillance, and procedural determinations about effective action (Council of the European Union, 2025; European Commission, 2026; Ministry of Finance of Poland, 2025). A conditional legal channel remains: macroeconomic conditionality may affect access to cohesion policy funding (Sacher, 2019), and Polish annual reporting under the excessive deficit procedure refers to restrictions on access to EU funds as a possible tightening channel where the relevant expenditure-path conditions are not met (Ministry of Finance of Poland, 2025).
...
A reading through risk-pricing and institutional channels points the same way. A debt ratio rising past the 60 percent Treaty reference value while the excessive deficit procedure remains active would expose the path to debt-service and interest-growth channels in debt dynamics (Blanchard, 2019; European Commission, 2026), and to market-pricing channels through sovereign-risk concerns, yields, and economy-wide borrowing costs (Huidrom, Kose, Lim and Ohnsorge, 2019). EU institutions would also assess the path through surveillance and corrective-procedure rules (European Commission, 2026), while domestic policymakers would face Poland's constitutional and statutory fiscal constraints together with the medium term fiscal structural plan and annual progress reporting framework (Constitution of the Republic of Poland, 1997; Public Finance Act, 2009; Ministry of Finance of Poland, 2024, 2025).
...
The investment import content evaluation for Poland yields an eighth-year cumulative output response of 1.80. Poland's evaluated import content sits slightly below the EU27 panel mean, with a raw value of 0.413 against the EU27 mean of 0.429 and a standardised value of -0.161. The comparison with the EU27 benchmark is not a mechanical, single-variable exercise. Within the investment import content specification, Poland's below-average state value raises the eighth-year output response relative to the same specification evaluated at the EU27 mean, while the EU27 benchmark reflects a distinct linear panel response without state interactions. The Polish investment import content trajectory runs above the EU27 benchmark initially, then falls below it from the third horizon onward. The result is a 2036 debt endpoint that is less self defeating than the EU27 benchmark, though still self defeating under a cut.

This pattern fits the trade multiplier literature. Import leakage and exchange-rate regime condition the size of fiscal multipliers (Ilzetzki, Mendoza and Vegh, 2013). Trade-flow analysis connects fiscal transmission to the relative import content of public and private expenditure, financing, and invoicing conditions (Cacciatore and Traum, 2020). Production-structure evidence links multiplier size to tradability and domestic value added content (Crespo Cuaresma and Glocker, 2023).

The household liquidity position Polish evaluation gives an eighth year cumulative output response of 2.24. Here Poland is evaluated through the household sector's net financial balance sheet position rather than through a direct credit flow measure. The state captures a financial accounts balance sheet channel. Kaplan, Violante and Weidner (2014) distinguish liquid resources from illiquid wealth in household consumption smoothing, while Bernardini, De Schryder and Peersman (2017) show that household leverage conditions the transmission of government spending shocks through balance sheet positions. Fiscal shocks can therefore transmit differently when household financial assets net of liabilities are weaker relative to GDP.
...
Centralny Port Komunikacyjny shows how a programme can keep formal continuity while its annual investment intensity falls sharply. The 2023 programme established the CPK investment programme for 2024-2030, with a State Treasury engagement limit of PLN 66.2 billion (Council of Ministers of Poland, 2023). The revised programme retains CPK in official planning, extends the active framework to 2024-2032, lowers the State Treasury engagement limit to PLN 62.9 billion, and sets total financing at PLN 131.7 billion (Council of Ministers of Poland, 2024b; Centralny Port Komunikacyjny, 2025). Relative to the earlier PLN 155.1 billion headline envelope, the revised plan lowers the envelope to PLN 131.7 billion, extends the timeline by two years, and reduces maximum annual State Treasury bond engagement from over PLN 13 billion to approximately PLN 11.5 billion (Council of Ministers of Poland, 2023, 2024b; Centralny Port Komunikacyjny, 2025).

These changes are more than presentational. They cut the scale and the annual public-financing intensity of the programme while preserving its formal title and official continuity. Within the surveillance context set out above, this is the mechanism by which public investment can be curtailed without explicitly cancelling a programme: the project remains formally intact, but its annual budgetary and implementation intensity is reduced through a smaller envelope, lower Treasury involvement, lower annual bond engagement, and postponement.

The Polish Nuclear Power Programme shows the same pattern: formal continuity with material deferral. The 2020 programme set the goal of constructing two nuclear power plants with a combined capacity of approximately 6 to 9 GWe and scheduled the first unit to enter operation in 2033 (Polish Nuclear Power Programme, 2020). The 2025 draft update keeps the approximately 6 to 9 GWe objective, but sets commercial operation of the first reactor for 2036, with subsequent units targeted for 2037 and 2038 (Ministry of Industry of Poland, 2025). Resolution No. 66 of 24 June 2024 revised Appendix 3 on implementation expenditure (Council of Ministers of Poland, 2024a). For the second nuclear power plant, the 2025 draft update describes a preparatory process covering technology selection, site selection, business-model design, administrative decisions, construction, and start-up, rather than a completed implementation route (Ministry of Industry of Poland, 2025).

Konin makes the shift concrete. The 2022 official documents detailed cooperation among PGE, ZE PAK and KHNP for Pątnów (Ministry of State Assets of Poland, 2022). Later reports indicated KHNP's withdrawal from the Polish nuclear project (Yonhap News Agency, 2025; Pulse, 2025). The 2025 draft programme places Konin within a broader set of coal-region locations under analysis alongside Bełchatów, Kozienice and Połaniec (Ministry of Industry of Poland, 2025), while a later official communication describes PGE taking full control of the company analysing potential nuclear locations and identifies Konin and Bełchatów as preferred locations in the government programme (Ministry of Energy of Poland, 2025).

Moving from a route centred on Pątnów cooperation with a designated foreign partner to renewed location and implementation analysis is evidence of material deferral behind formal programme continuity. More broadly, the nuclear programme shows that declared strategic continuity does not rule out significant restraint in the public-investment path when milestones, implementation routes, and annual expenditure profiles are deferred.
...
The second debt calculation is the direct debt-to-GDP local projection path. It estimates the debt-to-GDP response to the same public investment shock and applies that estimated debt ratio response to the same three annual actions. A cut initially increases the primary balance, yet the associated output loss and subsequent debt ratio response may still raise the debt ratio at the endpoint. An expansion initially lowers the primary balance, yet the associated output gain and resulting debt ratio response may lower the debt ratio at the endpoint. Debt-dynamics and hysteresis models evaluate fiscal policy through its effects on output persistence and debt-to-GDP ratios (DeLong and Summers, 2012; Fatas and Summers, 2018). The direct-debt calculation also parallels empirical research that links government investment shocks to public debt sustainability outcomes (Ciaffi, Deleidi and Di Domenico, 2024).
