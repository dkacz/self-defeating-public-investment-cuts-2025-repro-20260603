...
Household-liquidity 2025 coverage is complete for EU27 in the current Eurostat financial-accounts inputs. The paper headline response and debt tables remain unchanged; model-admission reference and reader outputs are synchronized.
